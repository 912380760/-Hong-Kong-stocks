    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.融资额度 === 1">一般</el-tag>
          <el-tag type="danger" v-if="scope.row.融资额度 === 0">少</el-tag>
        </template>
      </el-table-column>
      <el-table-column
          prop="融资一手"
      ...
      <el-table-column
          ...
          label="美股打新">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.美股打新 === 1">支持</el-tag>
          <el-tag type="danger" v-if="scope.row.美股打新 === 0">不支持</el-tag>
        </template>
      </el-table-column>
      <el-table-column
          prop="佣金说明"
...
<script>
 ...
 // 券商排序
 let qsArr = [
   '华泰', '恒大', '老虎', '辉立', '富途', '富昌', '耀才', '友信', '尊嘉', '有鱼', '青石', '华赢', '艾德', '阿尔法', '易昇', '方德',
   '玖富', '东财', '华盛通', '雪盈', '长桥', '利弗莫尔', '第一上海', '佳兆业', '盈路'];
