...
let data = [
    ...
    },
    {
        ...
        打新记录: [
            ...
            生成打新记录('尊嘉', '欧康维视生物', 8, 10),
            生成打新记录('东财', '欧康维视生物', 20, 10),
            生成打新记录('玖富', '欧康维视生物', 1, 10),
            生成打新记录('华盛通', '欧康维视生物', 1, 10),
            生成打新记录('华泰', '欧康维视生物', 300, 33),
            生成打新记录('艾德', '欧康维视生物', 10, 10),
    ...
    },
    {
        ...
        打新记录: [
            ...
            生成打新记录('富途', '思摩尔国际', 15, 10),
            生成打新记录('友信', '思摩尔国际', 1, 5),
            生成打新记录('东财', '思摩尔国际', 2, 10),
            生成打新记录('玖富', '思摩尔国际', 8, 10),
            生成打新记录('华盛通', '思摩尔国际', 6, 10),
