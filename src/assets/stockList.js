...
let data = [
    ...
    },
    {
        ...
        出售记录: [
            // 生成出售记录('尊嘉', '欧康维视生物', 43.9, 1, '2020/7/9'),
            // 生成出售记录('华泰', '欧康维视生物', 43.9, 1, '2020/7/9'),
        ]
    },
    {
        name: '思摩尔国际',
        ...
        出售记录: [
            ...
            // 生成出售记录('玖富', '思摩尔国际', 23.75, 1, '2020/7/9'),
            // 生成出售记录('华盛通', '思摩尔国际', 23.75, 1, '2020/7/9'),
        ]
    },
    {
        name: '永泰生物',
        ...
        出售记录: [
            // 生成出售记录('华泰', '永泰生物', 13.4, 1, '2020/7/9'),
        ]
    },
    {
        name: '正荣服务',
