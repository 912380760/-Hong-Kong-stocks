...
let data = [
  ...
  },
  {
    ...
    上市日期: "2020/9/25",
    list: [
      记录("富途", 40, 1, 0.9, 0.038),
      记录("辉立", 9, 1, 1, 0.0288, undefined, undefined, undefined, 38),
      记录("富昌", 1, 1, 1, 0.024, undefined, undefined, undefined, 38),
    ],
  },
  {
    ...
    list: [
      记录("富途", 1, 1, 0.9, 0.038),
      记录("辉立", 3, 1, 1, 0.0288, undefined, undefined, undefined, 38),
      记录("富昌", 1, 1, 1, 0.024, undefined, undefined, undefined, 38),
    ],
  },
  {
    ...
    中签定价: 0,
    上市日期: "2020/9/28",
    list: [记录("富昌", 1, 1, 1, 0.024, undefined, undefined, undefined, 38)],
  },
  {
    name: "宝尊电商",
    每手股数: 100,
  ...
  },
  {
    ...
    上市日期: "2020/9/25",
    list: [
      记录("富途", 25, 1, 0.9, 0.038),
      记录("华泰", 250, 1, 0.95, 0.038),
      // 记录("老虎", 20, 1, 0.95, 0.0403),
      // 记录("辉立", 190, 1, 0.9, 0.0288, undefined, undefined, undefined),
      // 记录("富昌", 1, 1, 1, 0.024, undefined, undefined, undefined, 38),
      // 记录("尊嘉", 10, 1, 0.8, 0.038),
      记录("艾德", 5, 1, 0.9, 0.038),
      记录("华盛通", 1, 1, 0.9, 0.038),
      // 记录("友信", 1, 1, 0.8, 0.038),
      // 记录("长桥", 1, 1, 0.8, 0.038),
