...
let data = [
  ...
  },
  {
    ...
    中签定价: 82.9,
    上市日期: "2020/9/29",
    list: [记录("富昌", 1, 1, 1, 0.024, 1, undefined, undefined, 38)],
  },
  {
    name: "嘉和生物-B",
    每手股数: 500,
    ...
    上市日期: "2020/10/7",
    list: [
      记录("富途", 14, 1, 0.9, 0.038),
      记录("华泰", 12, 1, 0.9, 0.038),
      记录("老虎", 40, 1, 0.933, 0.0403),
      记录("华赢", 20, 1, 0.9, 0.038),
      记录("辉立", 60, 1, 0.9, 0.0298),
      记录("盈路", 1, 1, 0.9, 0.05),
      记录("友信", 1, 1, 0.8, 0.038),
      记录("长桥", 1, 1, 0.9, 0.0399),
      记录("阿尔法", 1, 1, 0.9, 0.038),
      记录("华盛通", 1, 1, 0.9, 0.038),
      记录("尊嘉", 1, 1, 0.9, 0.038),
      记录("艾德", 1, 1, 0.9, 0.038),
      记录("佳兆业", 1, 1, 0.9, 0.045),
      记录("富昌", 4, 1, 1, 0.024, undefined, undefined, undefined, 58),
    ],
  },
  {
    name: "云顶新耀-B",
    ...
    list: [
      记录("富途", 1, 1, 0.9, 0.038),
      记录("华泰", 30, 1, 0.9, 0.038),
      记录("辉立", 1, 1, 1, 0.0288, undefined, undefined, undefined, 38),
