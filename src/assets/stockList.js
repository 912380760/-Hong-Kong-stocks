...
let data = [
  ...
  },
  {
    ...
    上市日期: "2020/10/30",
    list: [
      记录("华泰", 150, 1, 0.95, 0.038, 3, 6.07, "2020/12/24"),
...

  {
    ...
    上市日期: "2020/12/02",
    list: [
      记录("老虎", 1, 1, 0.933, 0.0388, 0),
      记录("老虎", 1, 1, 0.933, 0.0388, 1, 8, "2020/12/8"),
      记录("辉立", 2, 1, 1, 0, 1, 8.8, "2020/12/4", 0),
      记录("华泰", 18, 1, 0.933, 0.0388, 1, 8.8, "2020/12/4"),
      记录("华泰", 18, 1, 0.933, 0.0388, 2, 8.8, "2020/12/4"),
      记录("富途", 1, 1, 0.9, 0.0388, 0),
  ...
  },
  {
    ...
    上市日期: "2020/12/07",
    list: [
      记录("华泰", 200, 1, 0.97, 0.0388, 1, 94.95, "2020/12/8"),
      记录("华泰", 100, 1, 0.97, 0.0388, 1, 95.05, " 2020/12/8"),
      记录("华赢", 50, 1, 0.95, 0.0388, 0),
      记录("老虎", 80, 1, 0.933, 0.0398, 1, 94.45, "2020/12/8"),
      记录("老虎", 100, 1, 0.933, 0.0398, 1, 94.45, "2020/12/8"),
      记录("富途", 1, 1, 0.9, 0.0388, 1, 94.5, "2020/12/8"),
  ...
  },
  {
    ...
    上市日期: "2020/12/10",
    list: [
      记录("华泰", 35, 1, 0.97, 0.0388, 1, 62.85, "2020/12/14"),
      记录("辉立", 6, 1, 1, 0, 0, undefined, undefined, 38),
      记录("艾德", 6, 1, 0.9, 0.0388, 0),
      记录("友信", 1, 0, 0, 0.0388, 0),
  ...
  },
  {
    ...
    list: [
      ...
      记录("华泰", 20, 1, 0.95, 0.0388, 0),
      记录("华泰", 20, 1, 0.95, 0.0388, 0),
      记录("恒大", 40, 1, 0.95, 0.0398, 1, 15.38, "2020/12/21"),
      记录("青石", 1, 0, 0, 0.0388, 0),
  ...
  },
  {
    ...
    list: [
      ...
      记录("华泰", 10, 1, 0.9, 0.0388, 1, 1.75, "2020/12/28"),
      记录("华泰", 10, 1, 0.9, 0.0388, 1, 1.75, "2020/12/28"),
      记录("友信", 1, 0, 0, 0.0388, 0),
      记录("耀才", 1, 0, 0, 0.0388, 0),
    ],
